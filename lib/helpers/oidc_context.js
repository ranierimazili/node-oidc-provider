...
export default function getContext(provider) {
  ...
  class OIDCContext extends events.EventEmitter {
    ...
    urlFor(name, opt) {
      console.log("Debug urlFor");
      console.log("Original URL: ", this.ctx.req.originalUrl);
      console.log("Request URL: ", this.ctx.request.url);
      console.log("MountPath: ", this.ctx.mountPath);
      console.log("Base URL: ", this.ctx.req.baseUrl);
